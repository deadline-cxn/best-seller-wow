...
function bsTargetFaction()
    ...
    for floi=1, BSTooltip:NumLines(),1 do
        ...
        for factionIndex = 1, GetNumFactions() do
            name,,standingId,,,,,isHeader=GetFactionInfo(factionIndex)-- name,description,standingId,bottomValue,topValue,earnedValue,atWarWith,canToggleAtWar,isHeader,isCollapsed,hasRep,isWatched,isChild
